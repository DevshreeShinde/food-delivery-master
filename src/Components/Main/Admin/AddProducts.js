...
export default function AddProducts() {
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="prodname" onChange={prodname} required/>
  </div>
  <div class="form-group">
    <label >Product Price Per peice</label>
    <input type="number" class="form-control" id="prodpri" onChange={productPrice} required/>
  </div>
  <div class="form-group">
    <label >Quantity for the Product</label>
    <input type="number" class="form-control" id="prodquan" onChange={prodQuan} required/>
  </div>
  <div class="form-group">
